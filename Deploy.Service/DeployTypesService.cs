...
namespace Deploy.Service
{
    public class DeployTypesService
    {
        ...
        {
            var DeployChoices = _context.DeployChoices.Where(d => d.BaseOption == choices.DeployName && d.Domain == choices.Domain && d.Datadisk == choices.Datadisk && d.Solution == choices.Solution && d.Size == choices.Size).FirstOrDefault();
