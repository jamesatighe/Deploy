...
namespace Deploy.DAL.Migrations
{
    ...
    [Migration("20170706064254_DeployListGroup")]
    partial class DeployListGroup
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Deploy.DAL.DeployListGroup", b =>
                {
                    b.Property<int>("DeployListGroupID")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("DeployListGroupName");

                    b.Property<int?>("DeployListID");

                    b.HasKey("DeployListGroupID");

                    b.HasIndex("DeployListID");

                    b.ToTable("DeployListGroup");
                });
            ...
            modelBuilder.Entity("Deploy.DAL.DeployListGroup", b =>
                {
                    b.HasOne("Deploy.DAL.DeployList")
                        .WithMany("DeployListGroups")
                        .HasForeignKey("DeployListID");
                });
